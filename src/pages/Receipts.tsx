    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 text-center">
        <div className="max-w-md mx-auto space-y-4">
          <h2 className="text-xl font-semibold text-slate-800">Modul Khusus Penerimaan Kas</h2>
          <p className="text-slate-600">
            Saat ini, semua pencatatan transaksi termasuk penerimaan kas dilakukan melalui menu <strong>Jurnal Umum</strong>. 
